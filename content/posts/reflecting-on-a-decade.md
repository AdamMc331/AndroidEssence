...
Ten years ago today, I published [my first blog post](/hide-the-floatingactionbutton-when-scrolling-recyclerview). There's something special about looking back an entire decade at an achievement like that. A chance to reflect on what my life was like then, the motivations that got me into writing, and where I am today as a result. 

It has been an honor to learn in public over these last ten years, whether that be here on AndroidEssence, on [Twitch](https://twitch.tv/adammc), on [YouTube](https://youtube.com/@AdamMc331), at [Droidcon](https://www.droidcon.com/?filter-type=speakers&s=adam+mcneilly), or the countless number of meetups, hackathons, and other events that have enabled me to connect with the amazing Android community.

I started AndroidEssence with a simple goal - share what I've learned. I learned Android by hiding in a nook in my university's engineering center and consuming every Coursera and Udemy video I could find. I would engage and StackOverflow and other blogging sites to grow my domain knowledge however possible. Just about everything I learned came from another individual developer learning and sharing in the open to help others, [which has been the beauty of the Android community ever since it's inception](https://www.droidcon.com/2023/10/06/the-unyielding-spirit-of-android/).
...
My third (and more selfish) goal has always been to inspire. I hope that you have been motivated to pay it forward, even to just one other person. 
