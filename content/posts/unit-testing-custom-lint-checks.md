...
In our [previous post](posts/enforce-custom-views-with-lint) we looked at writing a custom lint check to enforce usages of a custom view instead of an Android framework implementation.
